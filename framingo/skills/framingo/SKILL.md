...
compatibility: Requires Go 1.24+. Documents github.com/xhanio/framingo v0.6.8 — where the repo's go.mod pins a different framingo version, trust the code over this prose.
metadata:
  author: xhanio
  version: "1.3.6" # mirrors plugin.json; bump both together
  framingo: v0.6.8 # the framework version these docs describe
---
